...
I used to build maybe one personal project a year, whenever the free time, the lust, and a good idea happened to overlap. I've shipped four to six in a month. Not to make money. Just things I wanted to exist, that occurred to me and then did.

The easy way to tell this is "AI agents 10x'd my output." And it _is_ the agents, none of this would probably happen without them. But I'd had the agents for a while and was still building one thing a year *tops*. What changed is the shape of the evening.

Once the kids are down (I've got two young kids, and the work has to fit around them, not the other way around) I sit for an hour or two, plan the whole thing, kick off the agents, and go to sleep. In the morning there's a largely working app waiting. Maybe it needs a few adjustments, but it's there. The evening I'd otherwise have spent scaffolding, and probably getting nowhere, is just done.
...
The agents need a plan on disk, so I have to make one. The plan used to live in my head, and ideas in your head fade. Writing it down for the agent also writes it down for future-me. I come back and the intent is still as sharp as it was the night before.
